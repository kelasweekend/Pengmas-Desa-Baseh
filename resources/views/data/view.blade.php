                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="javascript:var page = window.open('{{route('keluarga.pdf', $data->id)}}'); page.print()" class="btn btn-outline-primary btn-sm waves-effect waves-light float-right ml-2">Cetak PDF</a>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <form action="{{ route('keluarga.komoditi', $data->id) }}" method="POST">
                                            @csrf
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>Peternakan</td>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('keluarga.view', $data->id) }}",
                pageLength: 5,
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('keluarga.store_kk', $data->id) }}",
                    type: "POST",
                    dataType: 'json',
