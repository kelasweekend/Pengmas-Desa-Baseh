                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" name="title"
                                                    ...
                                                    placeholder="Ex Program Vaksinasi" autocomplete="off" required value="{{old('title')}}">
                                                @error('title')
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-2">
                                                ...
                                                <input type="text" name="kategori"
                                                    ...
                                                    id="kategori" placeholder="Ex Rakyat" autocomplete="off" required value="{{old('kategori')}}">
                                                @error('kategori')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('body') is-invalid @enderror"
                                                    name="body" id="summernote" rows="3">{{old('body')}}</textarea>
                                                @error('body')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
