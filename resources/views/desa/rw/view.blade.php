                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="javascript:var page = window.open('{{route('rw.keluarga.pdf', $data->id)}}'); page.print()"
                                    class="btn btn-outline-primary btn-sm waves-effect waves-light float-right ml-2">Cetak
                                    PDF</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <div class="col-md-1">
                                        <div class="mb-2">
                                            ...
                                            <input type="number" disabled readonly value="{{ $data->rt }}" name="rt"
                                                class="form-control" id="rt" placeholder="Ex 1" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="mb-2">
                                            ...
                                            <input type="number" disabled readonly name="rw" value="{{ $data->rw }}"
                                                class="form-control" id="rw" placeholder="Ex 2" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="desa" value="{{ $data->desa }}" class="form-control"
                                                id="desa" placeholder="Ex Baseh" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-2">
                                ...
                                <hr>
                                <h6 class="font-weight-bold text-primary">Tabel Anggota Keluarga</h6>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <form action="{{ route('rw.keluarga.komoditi', $data->id) }}" method="POST">
                                            @csrf
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>Peternakan</td>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('rw.keluarga.view', $data->id) }}",
                pageLength: 5,
            ...
            $('#saveBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('rw.keluarga.store_kk', $data->id) }}",
                    type: "POST",
                    dataType: 'json',
