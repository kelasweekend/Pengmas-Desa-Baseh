...
@section('title')
    Data Keluarga RT {{auth()->user()->no_rt}}
@endsection
                    ...
                    <form id="ItemForm" name="ItemForm" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="desa_wisma" class="form-control" id="desa_wisma"
                                        placeholder="Ex Kenanga" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="mb-2">
                                    <label for="rt" class="form-label">RT</label>
                                    <input type="number" name="rt" class="form-control" id="rt" readonly value="{{auth()->user()->no_rt}}"
                            ...
                            <div class="col-md-1">
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="rw" class="form-control" id="rw" readonly value="{{auth()->user()->no_rw}}"
                                        autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="wanita" class="form-control" id="wanita"
                            ...
                            <div class="col-md-1">
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="balita" class="form-control" id="balita"
                                        placeholder="Ex Baseh" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="ibu_hamil" class="form-control" id="ibu_hamil"
                                        placeholder="Ex Baseh" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                                <div class="mb-2">
                                    ...
                                    <input type="number" name="buta" class="form-control" id="buta"
                                        placeholder="Ex Baseh" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <p>Sumber Air ?</p>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="sumber_air" id="sumber_air1"
                                        value="pam">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="sumber_air" id="sumber_air2"
                                        value="sumur">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="sumber_air" id="sumber_air3"
                                        value="lainnya">
                                    <label class="form-check-label" for="sumber_air2">
                                        Lainnya
                                    </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p>Stiker P4K ?</p>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="stiker_p4k" id="stiker_p4k1"
                                        value="1">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="stiker_p4k" id="stiker_p4k2"
                                        value="0">
                            ...
                            <div class="col-md-4">
                                <p>Usaha Kesehatan ?</p>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kegiatan_usaha_kesehatan" id="kegiatan_usaha_kesehatan1"
                                        value="1">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="kegiatan_usaha_kesehatan" id="kegiatan_usaha_kesehatan2"
                                        value="0">
